def oi(other_args: List[str]):
    ...
    ns_parser: argparse.Namespace
        Parsed namespace
    """
    parser = argparse.ArgumentParser(add_help=False, formatter_class=argparse.ArgumentDefaultsHelpFormatter, prog='oi', description='Plot open interest.  Open interest represents the number of contracts that exist.')
